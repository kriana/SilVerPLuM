...
QT_MOC_LITERAL(3, 19, 7), // "retcode"
QT_MOC_LITERAL(4, 27, 15), // "processFinished"
QT_MOC_LITERAL(5, 43, 12), // "processError"
QT_MOC_LITERAL(6, 56, 22), // "QProcess::ProcessError"
QT_MOC_LITERAL(7, 79, 5) // "error"

    },
    "Launcher\0finished\0\0retcode\0processFinished\0"
...
void Launcher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Launcher::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Launcher::finished)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Launcher::finished(int _t1)
{
