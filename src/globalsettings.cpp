...
{
    m_DefaultExternalPrograms["msbuild"] = ExternalProgram(QStringList() << "/usr/local/bin/xbuild",
                                                           QStringList() << "{file}" <<"{insertargs}",
                                                           QStringList(),
                                                           true);
    m_DefaultExternalPrograms["nuget"] = ExternalProgram(QStringList() << "/usr/local/bin/nuget",
                                                           QStringList() << "{file}" << "{insertargs}",
                                                           QStringList(),
                                                         true);
    m_DefaultExternalPrograms["mono"] = ExternalProgram(QStringList() << "/usr/local/bin/mono",
                                                           QStringList() << "{file}" << "{insertargs}",
                                                           QStringList() << "application/x-ms-dos-executable",
                                                         true);
    m_DefaultExternalPrograms["bash"] = ExternalProgram(QStringList() << "/bin/bash",
                                                           ...
                                                           QStringList() << "application/x-shellscript",
                                                         true);
    m_DefaultExternalPrograms["python3"] = ExternalProgram(QStringList() << "/usr/local/bin/python3",
                                                           QStringList() << "{file}" << "{insertargs}",
                                                           QStringList() << "text/x-python",
                                                         true);
}
